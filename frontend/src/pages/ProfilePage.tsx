...
const ProfilePage = ({
  ...
  return (
    <div className="bodyImg px-[12px] text-white">
      {verifiedCertain && verified ? (
            ...
            {user != null ? (
                <>
                    <div className="w-[calc(100%-72px)] h-[260px] sm:h-[160px] bg-[#0000006d] mx-auto rounded-lg border border-borders">
                        <div
                            id="main"
                    ...
                    <div className="flex lg:flex-row sm:flex-col flex-col w-[calc(100%-72px)] mx-auto justify-between">
                        <div className="lg:w-[calc(40%-4px)] sm:w-full h-[240px] bg-[#0000006d] mt-[8px] rounded-lg border border-borders">
                        ...
                        <div className="lg:w-[calc(60%-4px)] sm:w-full sm:h-[240px] h-[450px] bg-[#0000006d] mt-[8px] rounded-lg border border-borders relative">
                            <div className="flex sm:flex-row flex-col justify-between">
                                ...
                                <div className="flex flex-col font-semibold relative mr-[50px] mt-[40px] w-[200px] sm:w-[280px] ml-[50px] sm:ml-0">
                                    <div className="text-[14px] relative">
                                        ...
                                        <div
                                            className={`sm:w-[280px] w-[200px] h-[8px] bg-borders mb-[16px] relative after:absolute bg-white easy-line after:h-[8px] after:rounded rounded after:bg-green-500`}
                                        ></div>
                                    </div>
                                    <div className="text-[14px] relative">
                                        <div className="flex flex-row justify-between">
                                        ...
                                        <div
                                            className={`sm:w-[280px] w-[200px] h-[8px] bg-borders mb-[16px] relative after:absolute bg-white medium-line after:h-[8px] after:rounded rounded after:bg-orange-500`}
                                        ></div>
                                    </div>
                                    <div className="text-[14px] relative">
                                        <div className="flex flex-row justify-between">
                                        ...
                                        <div
                                            className={`sm:w-[280px] w-[200px] h-[8px] bg-borders mb-[16px] relative after:absolute  hard-line after:h-[8px] after:rounded rounded after:bg-red-500 bg-white`}
                                        ></div>
                                        <style>
