...
const ProblemSet = ({
    ...
    return (
        <div className=" px-[12px]">
            ...
            <div className="h-[calc(100vh-60px)] overflow-hidden  text-[#ffffff9d]">
                <div
                    className="relative flex flex-row h-[calc(100vh-60px)] w-full mt-[8px] "
                >
                    <div
                        className="h-[calc(100%-16px)]  border border-borders ml-[8px] rounded-lg w-[calc(100%-16px)] overflow-hidden"
                    >
                        ...
                        <div className="w-full h-[40px] relative border-b border-borders">
                            <input
                                type="text"
